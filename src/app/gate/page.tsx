      ...
      <div className="max-w-sm w-full">
        ...
        <div className="bg-white rounded-3xl overflow-hidden shadow-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="px-6 pt-5 pb-4 text-center border-b border-gray-100">
            <p className="text-gray-800 font-bold text-base leading-snug mb-3">
              人生でやりたいことを<br />書き出してみませんか？
            </p>
          ...
          <div className="px-6 py-5">
            <label className="flex items-start gap-3 cursor-pointer mb-5">
              <input
                ...
                className="mt-0.5 w-5 h-5 accent-indigo-600 flex-shrink-0 cursor-pointer"
              />
              <span className="text-xs text-gray-500 leading-relaxed">
                次の結果は医療診断ではありません。正確な診断は専門医にご相談ください。
              </span>
            </label>
